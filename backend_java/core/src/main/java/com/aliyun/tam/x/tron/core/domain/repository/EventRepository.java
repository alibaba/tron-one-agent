...
public interface EventRepository {
    ...
    List<SessionEvent> pullEvents(String agentId, String sessionId, long offset, int size);

    EventSink createEventSink(String agentId, String userId, String sessionId, Long messageId);
}
